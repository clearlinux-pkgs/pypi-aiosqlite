...
Source0  : https://files.pythonhosted.org/packages/0d/3a/22ff5415bf4d296c1e92b07fd746ad42c96781f13295a074d58e77747848/aiosqlite-0.20.0.tar.gz
...
%prep
%setup -q -n aiosqlite-0.20.0
cd %{_builddir}/aiosqlite-0.20.0
pushd ..
cp -a aiosqlite-0.20.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708441402
