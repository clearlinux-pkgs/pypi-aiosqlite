...
Source0  : https://files.pythonhosted.org/packages/13/7d/8bca2bf9a247c2c5dfeec1d7a5f40db6518f88d314b8bca9da29670d2671/aiosqlite-0.21.0.tar.gz
...
%prep
%setup -q -n aiosqlite-0.21.0
cd %{_builddir}/aiosqlite-0.21.0
pushd ..
cp -a aiosqlite-0.21.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738596143
